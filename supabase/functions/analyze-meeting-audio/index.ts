...
// 16 הסטטוסים הרשמיים המאוחדים (עודכן 28.08.2026 יחד עם match-detail.html/matches-workspace.html)
// + קטגוריות סיבת ירידה - כדי שה-AI יבחר רק מתוכם
const MATCH_STATUSES = ['התאמה חדשה','ממתין לחתימת סודיות','נחתמה סודיות','מידע ראשוני נשלח','תקציר נשלח',
  ...
  'בבדיקת נתונים','במשא ומתן','הוקפא','נסגר ללא עסקה','עסקה הושלמה'];
...
{
  "suggested_title": "כותרת קצרה ותיאורית של 3-6 מילים לפי תוכן השיחה בפועל (למשל 'שיחה על דוחות כספיים ומחיר' או 'פגישת הכרות ראשונית') - לא 'שיחת טלפון' גנרי",
...
דוגמאות: "תעביר לי את דוחות 2025" -> משימה "להעביר דוחות 2025". "דבר איתי בשבוע הבא" -> next_action "לחזור לקונה בשבוע הבא". "לא מתאים לי בגלל המחיר" -> suggested_status "הקונה לא מעוניין", drop_reason_category "מחיר".
